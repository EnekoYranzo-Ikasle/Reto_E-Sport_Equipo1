...
CREATE TABLE competiciones (
    cod_comp NUMBER(4) NOT NULL GENERATED BY DEFAULT AS IDENTITY 
...
CREATE TABLE jornadas (
    cod_jornada NUMBER(4) NOT NULL GENERATED BY DEFAULT AS IDENTITY 
...
CREATE TABLE equipos (
    cod_equipo NUMBER(4) NOT NULL GENERATED BY DEFAULT AS IDENTITY 
...
CREATE TABLE jugadores (
    cod_jugador NUMBER(4) NOT NULL GENERATED BY DEFAULT AS IDENTITY 
    ...
    CONSTRAINT jug_codEqui_fk FOREIGN KEY (cod_jugador) -- Equipo
        REFERENCES equipos(cod_equipo)
);

CREATE TABLE enfrentamientos (
    cod_enfre NUMBER(4) NOT NULL GENERATED BY DEFAULT AS IDENTITY 
...
CREATE TABLE usuarios (
    id NUMBER(4) NOT NULL GENERATED BY DEFAULT AS IDENTITY 
